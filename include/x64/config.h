...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --enable-shared --target-os=win32 --arch=x86_32 --enable-gpl --enable-libx264 --enable-version3 --enable-libvo-aacenc extra-cflags=-I/devel/sreencast/out_bin/include --extra-cflags=-I/devel/sreencast/out-static/include --prefix=/devel/sreencast/out-master"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2014
#define FFMPEG_DATADIR "/devel/sreencast/out-master/share/ffmpeg"
#define AVCONV_DATADIR "/devel/sreencast/out-master/share/ffmpeg"
#define CC_IDENT "用于 x86 的 Microsoft (R) C/C++ 优化编译器 17.00.61030 版版权所有(C) Microsoft Corporation。保留所有权利。"
...
#define HAVE_STRUCT_POLLFD  1  //0 Justin.Wang chang 0 to 1 
...
#define CONFIG_LIBVO_AACENC_ENCODER 1
